...
class Moan extends EventEmitter {
   ...
   *
   * @param {Object} [options] - the options for the {@link Moan}
   * @param {boolean} [options.color=true] - <code>true</code> to enable colors when logging; otherwise
   * <code>false</code>
   * @param {boolean} [options.debug=false] - <code>true</code> to enable debug-level logging; otherwise
   * <code>false</code>
   * @public
   */
  constructor(options) {
     ...
     * @type {boolean}
     */
    this.color = typeof options.color === 'boolean' ? options.color : true
